...
def dd():
    df = pd.read_csv("716.csv",index_col = False)
    return df
...
st.write('Tracking daily (non) Utilization, Coverage, Speed, Gender gap, District variations of Covid-19 vaccine doses. Status as on 16 July 2021 , 11:27-11:35PM from CoWIN. ')
