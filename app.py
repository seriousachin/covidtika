...
def dd():
    df = pd.read_csv("723.csv",index_col = False)
    return df
...
st.write('Tracking daily (non) Utilization, Coverage, Speed, Gender gap, District variations of Covid-19 vaccine doses. Status as on 23 July 2021 , 11:52-11:59PM from CoWIN. ')
