...
def dd():
    df = pd.read_csv("729.csv",index_col = False)
    return df
...
st.write('Tracking daily (non) Utilization, Coverage, Speed, Gender gap, District variations of Covid-19 vaccine doses. Status as on 29 July 2021 , 11:40-11:50PM from CoWIN. ')
