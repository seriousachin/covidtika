...
def dd():
    df = pd.read_csv("727.csv",index_col = False)
    return df
...
st.write('Tracking daily (non) Utilization, Coverage, Speed, Gender gap, District variations of Covid-19 vaccine doses. Status as on 27 July 2021 , 11:33-11:40PM from CoWIN. ')
