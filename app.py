...
def dd():
    df = pd.read_csv("802.csv",index_col = False)
    return df
...
st.write('Tracking daily (non) Utilization, Coverage, Speed, Gender gap, District variations of Covid-19 vaccine doses. Status as on 2 August 2021 , 11:13-11:24PM from CoWIN. ')
